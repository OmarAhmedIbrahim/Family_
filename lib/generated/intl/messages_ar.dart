...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "admin": MessageLookupByLibrary.simpleMessage("-  كن مسؤولاً عن عائلتك"),
    "appDescription": MessageLookupByLibrary.simpleMessage(
      "تتبع رحلة قراءة القرآن الكريم لعائلتك معًا، وحدد قراءات يومية، واحتفل بالإنجازات كعائلة واحدة متحدة",
    ),
    "appGoal": MessageLookupByLibrary.simpleMessage(
    ...
    "invite": MessageLookupByLibrary.simpleMessage("أَنْشِئْ عائلة جديدة  "),
    "join": MessageLookupByLibrary.simpleMessage(
      "انضم إلى آلاف العائلات التي تقرأ القرآن معًا",
    ),
