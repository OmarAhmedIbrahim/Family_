                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          smallHeightSpace(),
                          CustomButton(onTap: (){}, buttonColor: buttonColor, text: "Create Family", width: screenWidth* 0.8,),
                          midHeightSpace(),
                        ],
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          smallHeightSpace(),
                          CustomButton(onTap: (){}, buttonColor: dividerColor, text: "Create Family", width: screenWidth* 0.8,textColor: Colors.black,),
                          midHeightSpace(),
                        ],
                      ),
                    ),
